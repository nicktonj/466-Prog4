...
if __name__ == '__main__':
    ...
    # added a time from sending first message to second message
    sleep(1)
    host_2.udt_send('H1', 'THIS_IS_THE_REPLY_MESSAGE_FROM_H2')
